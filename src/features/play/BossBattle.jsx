    ...
    return (
      <div className="boss-banner glass-card">
        ...
        <div className="conversion-fact-box" style={{ marginBottom: 20 }}>
          🔑 Remember: <span className="mass-value">Factor × Factor = Product</span>
        </div>
  ...
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      <FeedbackOverlay
        ...
        message={selected === question?.correctAnswer ? "That's exactly right! Well done! 🎉" : "Not quite! Remember: Factor × Factor = Product"}
