...
export default function PlayPhase({ onComplete, playNarration }) {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      {screen === 'playing' && (
        <motion.div key="playing" className="play-gameplay" style={{ position: 'absolute', inset: 0, top: 76, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '14px 14px 24px', overflowY: 'auto', overflowX: 'hidden' }}
          initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          {/* Breadcrumb */}
