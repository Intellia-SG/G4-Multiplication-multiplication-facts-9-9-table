...
const JOURNEY = [
  ...
  { num: '02', icon: '📖', label: 'Story',    desc: "Oliver & Emma's fair" },
  ...
  return (
    <div className="intro-wrap">
      ...
      <div className="intro-top-badge">
        ✨ Curriculum · Multiplication Facts up to 9×9 · Grade 4 & 5
      </div>

      {/* Main Title */}
      <h1 className="intro-title">
        <span className="text-orange">Multiply</span><span className="text-white">Quest</span>
      </h1>
      <h2 className="intro-subtitle">Multiplication Facts Mastery · Up to the 9×9 Times Tables</h2>

      {/* Mascot Row */}
      <div className="intro-mascot-row">
        <div className="intro-mascot-circle" title="Toby the Owl">🦉</div>
        <div className="intro-speech-bubble">
          Hi! I'm Toby. Ready to<br />master your times tables & fact families? ✖️🚀
        </div>
      </div>

      {/* Description */}
      <p className="intro-desc">
        Master <span className="text-yellow">multiplication facts up to 9×9</span>, discover the commutative flip property, explore visual arrays, and conquer all 10 kingdom boss battles!
      </p>
