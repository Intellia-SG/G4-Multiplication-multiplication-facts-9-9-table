...
const TAKEAWAYS = [
  { icon: '🔁', text: "Order doesn't matter — A × B always equals B × A." },
  { icon: '🧩', text: 'One multiplication fact connects to a whole family of related facts.' },
  { icon: '➗', text: 'Factor × Factor = Product — the same three numbers, just rearranged.' },
  { icon: '✔️', text: 'Doubling a known fact can quickly help you find a new one.' },
];

const CONFIDENCE_OPTIONS = [
  { emoji: '🌟', text: "I'm great at flipping facts!" },
  { emoji: '👍', text: 'I know most of my times tables!' },
    ...
    return (
      <div className="reflect-screen" style={{ justifyContent: 'center' }}>
        <div className="reflect-card glass-card" style={{ width: '100%', maxWidth: 520, textAlign: 'center' }}>
          ...
          <p style={{ fontWeight: 700, marginBottom: 16 }}>How confident do you feel about your multiplication facts, up to 9×9?</p>
      ...
      <div style={{ width: '100%', maxWidth: 560, display: 'flex', flexDirection: 'column', gap: 14, paddingBottom: 16 }}>
        ...
        <div className="reflect-card glass-card" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--color-text-muted)', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '0.9rem', marginTop: 6 }}>
            {pct >= 80 ? "Outstanding! You're a Multiplication Master! 🏆" : pct >= 60 ? "Well done! Keep practising! 💪" : "Review the key facts below 📚"}
          </p>
        </div>
        ...
        <div className="conversion-fact-box">
          <span className="mass-value">Factor × Factor = Product</span>
          <div style={{ fontSize: '0.85rem', marginTop: 4, color: 'rgba(255,255,255,0.65)' }}>
            Use doubling or flipping the order to check your answer
          </div>
        </div>
        ...
        <div className="reflect-badge glass-card">
          ...
          <div>
            ...
            <div className="reflect-badge-sub">Multiplication Facts up to 9×9</div>
          </div>
        </div>
